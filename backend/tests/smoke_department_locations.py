...
CASES = [
    {
        ...
        "contains": ("Applied Mathematics", "Science Building", "Opening map"),
    },
    {
        ...
        "contains": ("Department of English", "Center for Academic Success", "office/room"),
    },
    {
        ...
        "contains": ("Computer Science and Technology", "Green Lane Academic Building", "office/room 229"),
    },
    {
        "prompt": "where is the public administration department",
        "expected_mode": "department_location_direct",
        "expected_intent": "location",
        "expected_destination_id": "Hynes_hall",
        "contains": ("Criminal Justice and Public Affairs", "Hynes Hall", "office/room 505L"),
    },
    {
